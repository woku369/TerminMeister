...
// Icon-Aliase für bessere Lesbarkeit (wie in KalenderAnsicht)
const ChevronLeft = MdChevronLeft;
const ChevronRight = MdChevronRight;
const Today = MdToday;
const Park = MdPark;
const EventIconAlias = EventIcon;
      ...
      <Paper elevation={1} sx={{ p: 2, mb: 3 }}>
        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            ...
            <Typography variant="body2">Termine (bestätigt)</Typography>
          </Box>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            ...
            <Box sx={{ ml: 2 }}>
              {saisonStats.führungen > 0 && (
                <Typography variant="body2" sx={{ mb: 0.5 }}>
                  • {saisonStats.führungen} Kräutergarten und Mazerationsraum Events geplant
                </Typography>
              )}
